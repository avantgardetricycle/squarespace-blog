...
const featureData: Record<string, FeatureData> = {
  ...
  analytics: {
    ...
    desc: "Track clicks, search queries, most-read posts, reading depth, per-author analytics, and integrate with Google Analytics — all in one comprehensive dashboard.",
...
export function FeatureExplorer() {
  ...
  const badgeClass = {
    ...
    "badge-analytics": "bg-[#e8eaea] text-[#1a4a7a]",
  }[currentFeature.bc];
            ...
            <div className="bg-[#f7f6f3] lg:border-r border-[#e4e3de] overflow-y-auto lg:max-h-[780px] scrollbar-thin scrollbar-track-transparent scrollbar-thumb-[#e4e3de]">
              ...
              <div className="lg:hidden p-4 border-b border-[#e4e3de]">
                ...
                >
                  ...
                  <optgroup label="Insights & Analytics">
                    <option value="analytics">
                      {featureData["analytics"].name}
                    </option>
                  </optgroup>
                </select>
              </div>
              ...
              <FeatureItem
                id="analytics"
                name={featureData["analytics"].name}
                category="analytics"
...
function AnalyticsPanel() {
  return (
    <div className="bg-white rounded-xl border border-[#dde] shadow-[0_12px_48px_rgba(91,79,232,0.12),0_2px_8px_rgba(0,0,0,0.05)] overflow-hidden animate-[fadeUp_0.18s_ease_forwards]">
      ...
      <div className="p-4 px-5 border-b border-[#f0f0f0] flex items-center justify-between">
        <div className="font-heading text-base text-[#1a1a1a]">Analytics Dashboard</div>
        <div className="flex gap-[6px]">
          <div className="text-[0.56rem] px-[10px] py-1 rounded-[5px] bg-[#f0f0f0] text-[#666] font-medium">Last 7 days</div>
          <div className="text-[0.56rem] px-[10px] py-1 rounded-[5px] bg-[#5B4FE8] text-white font-semibold">Last 30 days</div>
          <div className="text-[0.56rem] px-[10px] py-1 rounded-[5px] bg-[#f0f0f0] text-[#666] font-medium">All time</div>
        </div>
      </div>
      ...
      <div className="p-4 px-5">
        ...
        <div className="grid grid-cols-4 gap-[10px] mb-4">
          <div className="bg-[#faf9ff] border border-[rgba(91,79,232,0.1)] rounded-lg p-3 px-[14px]">
            <div className="text-[0.52rem] text-[#999] font-medium tracking-[0.08em] uppercase mb-[5px]">Total Views</div>
            <div className="font-heading text-[1.4rem] text-[#1a1a1a] tracking-[-0.02em] leading-none">24,831</div>
            <div className="text-[0.52rem] text-[#1a7a5e] font-semibold mt-1">↑ 12% vs prev</div>
          </div>
          <div className="bg-[#faf9ff] border border-[rgba(91,79,232,0.1)] rounded-lg p-3 px-[14px]">
            <div className="text-[0.52rem] text-[#999] font-medium tracking-[0.08em] uppercase mb-[5px]">Unique Readers</div>
            <div className="font-heading text-[1.4rem] text-[#1a1a1a] tracking-[-0.02em] leading-none">8,204</div>
            <div className="text-[0.52rem] text-[#1a7a5e] font-semibold mt-1">↑ 8% vs prev</div>
          </div>
          <div className="bg-[#faf9ff] border border-[rgba(91,79,232,0.1)] rounded-lg p-3 px-[14px]">
            <div className="text-[0.52rem] text-[#999] font-medium tracking-[0.08em] uppercase mb-[5px]">Avg Read Time</div>
            <div className="font-heading text-[1.4rem] text-[#1a1a1a] tracking-[-0.02em] leading-none">3:42</div>
            <div className="text-[0.52rem] text-[#9a1a3e] font-semibold mt-1">↓ 4% vs prev</div>
          </div>
          <div className="bg-[#faf9ff] border border-[rgba(91,79,232,0.1)] rounded-lg p-3 px-[14px]">
            <div className="text-[0.52rem] text-[#999] font-medium tracking-[0.08em] uppercase mb-[5px]">Completion Rate</div>
            <div className="font-heading text-[1.4rem] text-[#1a1a1a] tracking-[-0.02em] leading-none">68%</div>
            <div className="text-[0.52rem] text-[#1a7a5e] font-semibold mt-1">↑ 5% vs prev</div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 mb-[14px]">
          {/* Traffic chart */}
          <div className="bg-white border border-[#f0f0f0] rounded-lg p-[14px]">
            <div className="text-[0.6rem] font-semibold text-[#1a1a1a] mb-3">Daily Views</div>
            {/* Bar chart */}
            <div className="flex items-end gap-1 h-16 mb-[6px]">
              <div className="flex-1 bg-[rgba(91,79,232,0.15)] rounded-t-sm" style={{ height: "40%" }}></div>
              <div className="flex-1 bg-[rgba(91,79,232,0.15)] rounded-t-sm" style={{ height: "55%" }}></div>
              <div className="flex-1 bg-[rgba(91,79,232,0.15)] rounded-t-sm" style={{ height: "45%" }}></div>
              <div className="flex-1 bg-[rgba(91,79,232,0.2)] rounded-t-sm" style={{ height: "70%" }}></div>
              <div className="flex-1 bg-[rgba(91,79,232,0.2)] rounded-t-sm" style={{ height: "60%" }}></div>
              <div className="flex-1 bg-[rgba(91,79,232,0.25)] rounded-t-sm" style={{ height: "80%" }}></div>
              <div className="flex-1 bg-[rgba(91,79,232,0.2)] rounded-t-sm" style={{ height: "65%" }}></div>
              <div className="flex-1 bg-[rgba(91,79,232,0.25)] rounded-t-sm" style={{ height: "75%" }}></div>
              <div className="flex-1 bg-[rgba(91,79,232,0.3)] rounded-t-sm" style={{ height: "90%" }}></div>
              <div className="flex-1 bg-[rgba(91,79,232,0.25)] rounded-t-sm" style={{ height: "72%" }}></div>
              <div className="flex-1 bg-[#5B4FE8] rounded-t-sm" style={{ height: "100%" }}></div>
              <div className="flex-1 bg-[rgba(91,79,232,0.2)] rounded-t-sm" style={{ height: "68%" }}></div>
            </div>
            <div className="flex justify-between">
              <div className="text-[0.48rem] text-[#ccc]">Mar 1</div>
              <div className="text-[0.48rem] text-[#ccc]">Mar 15</div>
              <div className="text-[0.48rem] text-[#ccc]">Mar 30</div>
            </div>
          </div>

          {/* Traffic sources */}
          <div className="bg-white border border-[#f0f0f0] rounded-lg p-[14px]">
            <div className="text-[0.6rem] font-semibold text-[#1a1a1a] mb-3">Traffic Sources</div>
            <div className="flex flex-col gap-2">
              <div>
                <div className="flex justify-between mb-[3px]">
                  <span className="text-[0.56rem] text-[#555]">Organic Search</span>
                  <span className="text-[0.56rem] text-[#1a1a1a] font-semibold">52%</span>
                </div>
                <div className="h-[5px] bg-[#f0f0f0] rounded-full">
                  <div className="w-[52%] h-full bg-[#5B4FE8] rounded-full"></div>
                </div>
              </div>
              <div>
                <div className="flex justify-between mb-[3px]">
                  <span className="text-[0.56rem] text-[#555]">Social</span>
                  <span className="text-[0.56rem] text-[#1a1a1a] font-semibold">24%</span>
                </div>
                <div className="h-[5px] bg-[#f0f0f0] rounded-full">
                  <div className="w-[24%] h-full bg-[#8F86F0] rounded-full"></div>
                </div>
              </div>
              <div>
                <div className="flex justify-between mb-[3px]">
                  <span className="text-[0.56rem] text-[#555]">Direct</span>
                  <span className="text-[0.56rem] text-[#1a1a1a] font-semibold">16%</span>
                </div>
                <div className="h-[5px] bg-[#f0f0f0] rounded-full">
                  <div className="w-[16%] h-full bg-[#c4bff5] rounded-full"></div>
                </div>
              </div>
              <div>
                <div className="flex justify-between mb-[3px]">
                  <span className="text-[0.56rem] text-[#555]">Email</span>
                  <span className="text-[0.56rem] text-[#1a1a1a] font-semibold">8%</span>
                </div>
                <div className="h-[5px] bg-[#f0f0f0] rounded-full">
                  <div className="w-[8%] h-full bg-[#dde] rounded-full"></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white border border-[#f0f0f0] rounded-lg overflow-hidden">
          <div className="p-[10px] px-[14px] border-b border-[#f0f0f0] flex items-center justify-between">
            <div className="text-[0.6rem] font-semibold text-[#1a1a1a]">Top Posts</div>
            <div className="text-[0.52rem] text-[#5B4FE8] font-medium">View all →</div>
          </div>
          <div className="grid grid-cols-[1fr_60px_60px_60px] px-[14px] py-[6px] bg-[#fafafa] border-b border-[#f5f5f5]">
            <div className="text-[0.5rem] font-bold text-[#bbb] tracking-[0.1em] uppercase">Post</div>
            <div className="text-[0.5rem] font-bold text-[#bbb] tracking-[0.1em] uppercase text-right">Views</div>
            <div className="text-[0.5rem] font-bold text-[#bbb] tracking-[0.1em] uppercase text-right">Avg Time</div>
            <div className="text-[0.5rem] font-bold text-[#bbb] tracking-[0.1em] uppercase text-right">Done</div>
          </div>
          <div className="grid grid-cols-[1fr_60px_60px_60px] px-[14px] py-2 border-b border-[#f5f5f5] items-center">
            <div className="text-[0.6rem] text-[#1a1a1a] font-medium leading-[1.3]">Finding balance in a busy creative life</div>
            <div className="text-[0.6rem] text-[#555] text-right">6,421</div>
            <div className="text-[0.6rem] text-[#555] text-right">4:12</div>
            <div className="text-[0.6rem] text-[#1a7a5e] font-semibold text-right">74%</div>
          </div>
          <div className="grid grid-cols-[1fr_60px_60px_60px] px-[14px] py-2 border-b border-[#f5f5f5] items-center">
            <div className="text-[0.6rem] text-[#1a1a1a] font-medium leading-[1.3]">My morning ritual and why it works</div>
            <div className="text-[0.6rem] text-[#555] text-right">4,809</div>
            <div className="text-[0.6rem] text-[#555] text-right">3:55</div>
            <div className="text-[0.6rem] text-[#1a7a5e] font-semibold text-right">69%</div>
          </div>
          <div className="grid grid-cols-[1fr_60px_60px_60px] px-[14px] py-2 items-center">
            <div className="text-[0.6rem] text-[#1a1a1a] font-medium leading-[1.3]">The case for slow living</div>
            <div className="text-[0.6rem] text-[#555] text-right">3,214</div>
            <div className="text-[0.6rem] text-[#555] text-right">2:48</div>
            <div className="text-[0.6rem] text-[#9a1a3e] font-semibold text-right">51%</div>
          </div>
        </div>
      </div>
    </div>
